# Title: Spatial Overlap Analysis of Functional and Taxonomic Diversity in Protected Areas
...
# Overview:  This script calculates spatial overlap between functional and taxonomic diversity maps 
# (for mammals, birds, and combined metrics) and protected areas. It assesses the area overlap 
# at various thresholds and quantifies the proportion of biodiversity dimensions within protected areas.
# Data Output: 
#   - Projected rasters for binary species richness (SR), functional diversity (FD), and overlap
#   - Summary CSV file with area calculations and protection percentages
