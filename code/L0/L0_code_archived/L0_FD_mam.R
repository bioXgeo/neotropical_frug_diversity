...
writeRaster(fd_raster_mam$ID, "FD_mams_TA_ID.tif", format="GTiff")
...
asb_sp_mam_summ_final <- mFD::asb.sp.summary(asb_sp_w = subset_matrix)

# Occurences 
asb_sp_mam_occ <- asb_sp_mam_summ_final$"asb_sp_occ"

#richness per cell
asb_sp_mam_summ_final$"asb_sp_richn"   # Species richness per assemblage

# Names of species present in random assemblage
asb_sp_mam_summ_final$"asb_sp_nm"[[6015]]   
